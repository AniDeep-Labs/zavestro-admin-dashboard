    ...
    <div className={styles.page}>
      ...
      <div className={styles.kpiRow}>
        <div className={styles.kpiCard}>
          <div className={`${styles.kpiIconBox} ${styles.kpiIconNeutral}`}>
            <UilInbox size={16} />
          </div>
        ...
        <div className={styles.kpiCard}>
          <div className={`${styles.kpiIconBox} ${styles.kpiIconRed}`}>
        ...
        <div className={styles.kpiCard}>
          <div className={`${styles.kpiIconBox} ${styles.kpiIconYellow}`}>
            <UilClock size={16} />
          </div>
          <div className={`${styles.kpiVal} ${styles.kpiYellow}`}>
            {inProgress}
          </div>
        ...
        <div className={styles.kpiCard}>
          <div className={`${styles.kpiIconBox} ${styles.kpiIconOrange}`}>
            <UilUserMinus size={16} />
          </div>
          <div className={`${styles.kpiVal} ${styles.kpiOrange}`}>
            {unassigned}
          </div>
